...
import { OsmoticParams} from "./OsmoticPool.sol";
    ...
    UUPSUpgradeable
{
    ...
    function initialize(
        ...
        beacon = new UpgradeableBeacon(_osmoticPool, msg.sender);
    ...
    function createOsmoticPool(
        ...
        return _createOsmoticPool(_initPoolData);
    }

    function createOsmoticPool(
        bytes calldata _initPayload
    ) external virtual whenNotPaused returns (address pool_) {
        return _createOsmoticPool(_initPayload);
    }
    //--------------------------------------------------------------------//
    //                      MIMETkn-functions                             //
    //--------------------------------------------------------------------//
    ...
    function completeBuild(
        ...
        }
        {
            ...
            pool_ = _createOsmoticPool(_initLoad);
        }
        _rAddresses[0] = list_;
        _rAddresses[1] = mime_;
        _rAddresses[2] = pool_;
